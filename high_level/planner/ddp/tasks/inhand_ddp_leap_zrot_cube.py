...
X_AXIS_LENGTH=0.08
QSIM_MODEL_PATH = os.path.join(YML_PATH, "leap_3d_zrot_cube.yml")
MODEL_PARAM_PATH = os.path.join(CONFIG_PATH, "leap_3d_zrot_cube.yaml")
...
def solve_ddp_trajopt_problem(
    ...
    np.save("../optimizer/warmstart/xs_trival_cube_leap.npy", solver.xs)
    np.save("../optimizer/warmstart/us_trival_cube_leap.npy", solver.us)
...
def prepare_everything_for_ROS():
    ...
    xs_init, us_init = np.load("../optimizer/warmstart/xs_trival_cube_leap.npy"), \
                        np.load("../optimizer/warmstart/us_trival_cube_leap.npy")
