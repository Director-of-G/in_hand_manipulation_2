...
X_AXIS_LENGTH=0.08
QSIM_MODEL_PATH = os.path.join(YML_PATH, "allegro_3d_full_zrot_cube.yml")
...
def solve_ddp_trajopt_problem(
    ...
    np.save("../optimizer/warmstart/xs_trival_full_cube.npy", solver.xs)
    np.save("../optimizer/warmstart/us_trival_full_cube.npy", solver.us)
...
if __name__ == "__main__":
    ...
    xs_init, us_init = np.load("../optimizer/warmstart/xs_trival_full_cube.npy"), \
                        np.load("../optimizer/warmstart/us_trival_full_cube.npy")
