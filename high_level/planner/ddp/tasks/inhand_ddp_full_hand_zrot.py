...
X_AXIS_LENGTH=0.08
QSIM_MODEL_PATH = os.path.join(YML_PATH, "allegro_3d_full_zrot.yml")
...
class QuasistaticActionModel(crocoddyl.ActionModelAbstract):
    ...
    def calc(self, data, x, u=None):
        ...
        self.sim_params.log_barrier_weight = KAPPA_FORWARD
    ...
    def calcDiff(self, data, x, u=None):
        ...
        self.sim_params.log_barrier_weight = KAPPA_BACKWARD
...
def solve_ddp_trajopt_problem(
    ...
    # np.save("../optimizer/warmstart/xs_trival_full.npy", solver.xs)
    # np.save("../optimizer/warmstart/us_trival_full.npy", solver.us)
    import pdb; pdb.set_trace()
...
if __name__ == "__main__":
    ...
    xs_init, us_init = np.load("../optimizer/warmstart/xs_trival_full.npy"), \
                        np.load("../optimizer/warmstart/us_trival_full.npy")
